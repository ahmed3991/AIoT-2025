...
#include "model_data.h"   // compiled TFLite model
#include <vector>
#include <random>
#include <cstring>
...
void loop()
{
    ...
    if (buttonState == HIGH && takeNewPicture)
    {
        ...
        lcd.setCursor(0, 0);
        lcd.print("Predicting img");
        lcd.print(image_index);
        lcd.print("   ");
        ...
        memcpy(input->data.int8, model_input_data, input->bytes);
        ...
        // Print the predicted class index and name, and compare with the true class
